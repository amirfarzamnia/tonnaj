...
export const POST = async (request: NextRequest) => {
    ...
    if (phone_number) {
        KavenegarApi({ apikey: '6B57554970696A54724C6536785034716559324A6B78734D734C304E4C4C623073494A4E3574782B4C70303D' }).Send({ message: 'خدمات پیام کوتاه کاوه نگار', sender: '1000689696', receptor: '09130288776' }, () => {
            console.log(true);
        });
